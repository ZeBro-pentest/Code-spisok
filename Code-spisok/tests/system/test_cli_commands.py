...
def run_test(user_input: str, expected_outputs: list[str]):
    ...
    process = subprocess.run(
        ...
        # cwd = os.getcwd(),     # рабочая директория
        input=user_input,
        capture_output=True,
        text=True,
    ...
    # гарантия, что программа не выдала ошибку при работе.
    # Без этой строки тест мог бы “прошёл” даже при падении кода, если бы вывод случайно совпал с ожидаемым.
    # хз зачем но ладно
