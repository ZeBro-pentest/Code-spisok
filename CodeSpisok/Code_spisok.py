...
print(f"Список '{list_name}' создан. Введите команды для управления списком.")
...
while True:
    ...
    if command == "add":
    ...
    elif command == "ft_el": # узнать элемент(по индексу)
    ...
    elif command == "ft_ind": # узнать индекс(по элементу)
        ...
        print("---------------------------------------------\nadd -- добавить\nren -- переименовать список\nrev -- перевернуть список\nshow -- показать список\nclear -- очистить список\nexit -- выйти\nel_chek -- (element chek) проверка элементов\nrem_el -- (remove element) удалить элемент по названию\nrem_ind -- (remove index) удалить элемент по индексу\nrep_el -- (replace element) заменить элемент по названию\nrep_ind -- (replace index) заменить элемент по индексу\nft_el -- (find the element) узнать элемент по индексу\nft_ind -- (find the index) узнать индекс элемента по названию\n---------------------------------------------")
