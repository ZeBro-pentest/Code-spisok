...
while True:
    ...
    if command == "add":
        ...
        print("    clear     - очистить список")
        print("    el_check  - проверить наличие элемента")
        print("    exit      - выйти из программы")
        print("    fd_el     - найти элемент по индексу")
        print("    fd_ind    - найти индекс элемента по названию")
        print("    rem_el    - удалить элемент по названию")
        print("    rem_ind   - удалить элемент по индексу")
        print("    ren       - переименовать список")
        print("    rep_el    - заменить элемент по названию")
        print("    rep_ind   - заменить элемент по индексу")
        print("    rev       - перевернуть список")
        print("    show      - показать список")
        print("-----------------------------------------------------------")
